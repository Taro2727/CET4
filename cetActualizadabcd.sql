...
--
-- Table structure for table `likes_rta`
--

DROP TABLE IF EXISTS `likes_rta`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
--
-- Dumping data for table `likes_rta`
--

LOCK TABLES `likes_rta` WRITE;
/*!40000 ALTER TABLE `likes_rta` DISABLE KEYS */;
/*!40000 ALTER TABLE `likes_rta` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `preg` VALUES (1,'hola','hola','2025-06-19 22:59:02',10,3),(2,'hola','hola','2025-06-20 01:16:21',10,2),(3,'hola','hola','2025-06-20 01:16:46',10,4),(4,'hola','hola','2025-06-20 02:09:38',10,1);
...
INSERT INTO `rta` VALUES (1,'hola','2025-06-19 22:59:10',1,10),(2,'hola','2025-06-20 01:16:27',2,10),(3,'hola','2025-06-20 01:16:52',3,10);
...
INSERT INTO `usuario` VALUES (1,'TaylorSwift123','chau@gmail.com','hola'),(3,'hola','chauchi@gmail.com','hola'),(4,'intento123','iasgd@gmail.com','miedo'),(5,'pepeargento','hahga@gmail.com','hola'),(9,'monicaragento','moni@gmail.com','123'),(10,'holacata','holacata@gmail.com','scrypt:32768:8:1$FxEKA7RuWjQP7mHn$3c09ce82352e340954075b8d5b58e31395fa44085bcf459bf58f84e6c96d70ef8ad89c91abb204f0d4b8b9ba2005aa58d51b84f7da03f746444448c712f838f7');
...
-- Dump completed on 2025-07-27 20:49:16
